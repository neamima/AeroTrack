...
- **Part Registration** — Manufacturers can register new parts with a unique serial number on-chain.
...
```solidity
// 1. Manufacturer registers a new part
aeroTrack.manufacturePart(100123, "Turbine Blade A7");

// 2. Manufacturer ships the part to a maintenance facility
aeroTrack.transferPart(100123, 0xMaintenanceFacilityAddress);

// 3. Maintenance facility logs an inspection report
